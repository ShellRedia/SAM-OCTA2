...
class TrainManager:
    ...
    def train(self):
        ...
        save_dir = "result/SparseAnnotation_RV_train/{}".format(self.time_str)
        os.makedirs(save_dir, exist_ok=True)
        
        torch.save(self.model.state_dict(), '{}/sparse_annotation_rv_{}.pth'.format(save_dir, 0))
        ...
        for epoch in range(1, self.epochs+1):
            ...
            if epoch % self.save_interval == 0:
                torch.save(self.model.state_dict(), '{}/sparse_annotation_rv_{}.pth'.format(save_dir, epoch))
